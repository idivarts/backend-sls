...
// connected account (used on disconnect). The brand-level analyticsOverview is
// an aggregate across all accounts and is regenerated by the analytics worker,
// so it is intentionally left intact. Returns the total docs deleted.
