...
const (
	...
	// Values for the `platform` parameter on the Page Conversations API
	// (GET /{page-id}/conversations?platform=...). Messenger is the Facebook
	// Page inbox; Instagram is the IG-via-Page legacy flow (new IG-Login
	// accounts use pkg/instagram via graph.instagram.com instead).
